...
已发布研究使用 2026-01-02 至 2026-06-10 的中国指数期权和对应期货日内数据。
第一阶段原型共完成 4 笔交易，其中 3 笔盈利；报告累计收益为 30.5%，最大回撤为
-0.92%。

扩展策略评估披露了以下结果：

| 策略 | 胜率 | 平均收益 | 最好收益 | 最差收益 |
|---|---:|---:|---:|---:|
...
这些结果来自较短的 2026 年样本，只应视为初步研究证据，不能证明稳定的样本外
盈利能力。受许可限制的原始市场数据和自动生成的研究表未纳入公开仓库，因此第三方
无法仅依靠仓库完整复算上述数字。详细内容见
[第一阶段报告](research/reports/Seven_Goal_Project_Report_v1.pdf)和
[技术白皮书](research/reports/quant_option_technical_white_paper_cn_v1_0.docx)。
