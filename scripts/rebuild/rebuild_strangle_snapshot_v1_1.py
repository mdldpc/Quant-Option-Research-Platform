...
INPUT_FILE = Path("research/datasets/option_strangle_dataset_2026H1_v1_1.parquet")

OUT_DATASET = Path("research/datasets/strangle_daily_snapshot_2026H1_v1_1.parquet")
OUT_CSV = Path("research/exports/strangle_daily_snapshot_2026H1_v1_1.csv")
OUT_REPORT = Path("research/reports/strangle_daily_snapshot_v1_1_report.txt")


def main():
    print("Reading strangle dataset v1.1...")
