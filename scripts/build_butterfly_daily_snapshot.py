...
INPUT_FILE = Path("research/datasets/butterfly_dataset_filtered_2026H1.parquet")

OUT_DATASET = Path("research/datasets/butterfly_daily_snapshot_2026H1.parquet")
OUT_CSV = Path("research/exports/butterfly_daily_snapshot_2026H1.csv")
OUT_REPORT = Path("research/reports/butterfly_daily_snapshot_report.txt")
