...
INPUT_FILE = Path("research/datasets/calendar_spread_dataset_2026H1.parquet")

OUT_DATASET = Path("research/datasets/calendar_daily_snapshot_2026H1.parquet")
OUT_CSV = Path("research/exports/calendar_daily_snapshot_2026H1.csv")
OUT_REPORT = Path("research/reports/calendar_daily_snapshot_report.txt")


def main():
    print("Reading calendar spread dataset...")
